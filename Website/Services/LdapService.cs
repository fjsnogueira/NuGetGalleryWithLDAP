...
namespace NuGetGallery
{
    public class LdapService : ILdapService
    {
        ...
        public SearchResult GetUserSearchResult(string username, string password)
        {
            ...
            return new DirectorySearcher(GetDirectoryEntry(username, password), string.Format(null,"({0}={1})", new [] {Properties.Username, username}), new[] { Properties.Username, Properties.DisplayName, Properties.Email }).FindOne();
        }
